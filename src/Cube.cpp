...
namespace Game
{
			   ...
			   , m_size(std::move(size))
	{
		...
		auto pTop = ResourceManager::loadAnimatedPolygon("Top", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Top");
		auto pBottom = ResourceManager::loadAnimatedPolygon("Bottom", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Bottom");
		auto pFront = ResourceManager::loadAnimatedPolygon("Front", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Left");
		auto pBack = ResourceManager::loadAnimatedPolygon("Back", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Left");
		auto pRight = ResourceManager::loadAnimatedPolygon("Right", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Left");
		auto pLeft = ResourceManager::loadAnimatedPolygon("Left", "DefaultTextureAtlas", "PolygonShader", 8, 8, "Grass_Left");

		m_polygones_positions[0] = glm::vec3(0, 4, 0);
		m_polygones_positions[1] = glm::vec3(0, -4, 0);
		m_polygones_positions[2] = glm::vec3(0, 0, 4);
		m_polygones_positions[3] = glm::vec3(0, 0, -4);
		m_polygones_positions[4] = glm::vec3(4, 0, 0);
		m_polygones_positions[5] = glm::vec3(-4, 0, 0);
